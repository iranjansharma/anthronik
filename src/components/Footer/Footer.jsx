...
const Footer = () => {
  return (
    <>
      <footer className='w-full relative z-10 bg-gray-900 pt-20 pb-10 lg:pt-[50px] lg:pb-2'>
        <div className='container w-11/12 mx-auto'>
          <div className='flex flex-wrap'>
            <div className='w-full px-4 sm:w-2/3 lg:w-3/12'>
              <div className='w-full mb-10'>
                <a href='/s' className='mb-6 inline-block max-w-[160px]'>
                  <img src={Logo} alt='logo' className='max-w-full' />
                </a>
                <p className='text-[16px] mb-7 text-white font-light leading-6 capitalize'>
                  ANTHRONIK is a research-based facilitator and project executor
                  with extensive experience in fostering Academia-Industry
                  collaboration.
                </p>
                <p className='flex items-center text-white text-sm font-bold text-dark'>
            ...
            <LinkGroup header='Services'>
              <NavLink link='/#services' label='Strategic Intervention' />
              <NavLink link='/#services' label='Learning & Innovation' />
              <NavLink link='/#services' label='Collaboration' />
              <NavLink link='/#services' label='Conferences & Seminars' />
              <NavLink link='/#services' label='Summits' />
              <NavLink
                link='/#services'
                label='Technical Evaluation Consulting '
              />
              <NavLink link='/#services' label='Project Execution' />
            </LinkGroup>
            <LinkGroup header='Events'>
              <NavLink link='/#events' label='Past Events' />
              <NavLink
                link='https://forms.gle/eHmqwMEVodo8QzDx7'
                label='Register For Upcomig Events'
              />
            </LinkGroup>
            ...
            <div className='w-full px-4 sm:w-1/2 lg:w-3/12'>
              <div className='w-full mb-10'>
                ...
                <div className='flex items-center mb-6'>
                  <a
                    href='/#'
                    className='mr-3 text-white flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] text-dark hover:border-primary hover:bg-primary hover:text-green-500 sm:mr-4 lg:mr-3 xl:mr-4'
                  >
                    <svg
                      width={8}
                      height={16}
                  ...
                  <a
                    href='/#'
                    className='mr-3 flex h-8 w-8 text-white items-center justify-center rounded-full border border-[#E5E5E5] text-dark hover:border-primary hover:bg-primary hover:text-green-500 sm:mr-4 lg:mr-3 xl:mr-4'
                  >
                    <svg
                      width={16}
                      height={12}
                  ...
                  <a
                    href='/#'
                    className='mr-3 flex text-white h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] text-dark hover:border-primary hover:bg-primary hover:text-green-500 sm:mr-4 lg:mr-3 xl:mr-4'
                  >
                    <svg
                      width={16}
                      height={12}
                  ...
                  <a
                    href='/#'
                    className='mr-3 flex h-8 w-8 items-center text-white justify-center rounded-full border border-[#E5E5E5] text-dark hover:border-primary hover:bg-primary hover:text-green-500 sm:mr-4 lg:mr-3 xl:mr-4'
                  >
                    <svg
                      width={14}
                      height={14}
                ...
                <p className='text-base text-white'>
                  © {new Date().getFullYear()} Anthronik
                </p>
              </div>
            </div>
          </div>
        ...
        <div className='flex flex-wrap items-center md:justify-between lg:justify-center'>
          <div className='w-full md:w-4/12 mx-auto text-center items-center'>
            <div className='text-[16px] text-white pb-2 font-light'>
              Copyright ©{' '}
              <span id='get-current-year'>{new Date().getFullYear()} | </span>
              <a
                href='https://anthronikdemo.netlify.app'
                className='text-blueGray-500 hover:text-green-500'
                target='_blank'
                rel='noreferrer'
              >
                Anthronik |
              ...
              &nbsp; Created with ❤️ By
              <a
                href='https://www.startuptostandup.com'
...
const LinkGroup = ({ children, header }) => {
  return (
    <>
      <div className='w-full text-white px-4 sm:w-1/2 lg:w-2/12'>
        <div className='w-full mb-10'>
          <h4 className='text-[20px] font-semibold mb-9 text-dark'>{header}</h4>
          <ul>{children}</ul>
        </div>
      </div>
    </>
  ...
  return (
    <div>
      <li>
        <a
          href={link}
          className={`inline-block mb-2 text-[14px] font-light leading-loose hover:text-green-500 ease-in-out`}
        >
          {label}
        </a>
      </li>
