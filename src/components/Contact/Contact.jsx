          ...
          <div className='flex flex-wrap -mx-4 lg:justify-between'>
            <div className='w-full px-4 lg:w-1/2 xl:w-6/12'>
              <div className='mb-12 max-w-[570px] lg:mb-0'>
                ...
                <h2 className='mb-6 text-[20px] font-bold uppercase text-gray-900 sm:text-[40px] lg:text-[20px] xl:text-[40px]'>
                  GET IN TOUCH WITH US
                </h2>
                <p className='text-[16px] leading-relaxed mb-9 text-gray-900 font-light'>
                ...
                <div className='mb-8 flex w-full max-w-[370px]'>
                  ...
                  <div className='w-full'>
                    <h4 className='mb-1 text-[18px] font-bold text-gray-900'>
                      Our Location
                    </h4>
                ...
                <div className='mb-8 flex w-full max-w-[370px]'>
                  ...
                  <div className='w-full'>
                    <h4 className='mb-1 text-[18px] font-bold text-dark'>
                      Phone Number
                    </h4>
                    <p className='text-[16px] text-gray-900'>
              ...
              <div className='relative p-8 bg-white rounded-lg shadow-lg sm:p-12'>
                ...
                >
                  <label className='flex flex-col'>
                    <span className='text-gray-900 font-bold mb-4'>
                      Your Name *
                    </span>
                    <input
                      type='text'
                  ...
                  <button
                    type='submit'
                    className='bg-tertiary py-3 px-10 outline-none w-fit bg-gray-800 text-white text-[16px] font-bold shadow-md shadow-primary rounded-xl hover:bg-blue-800  hover:text-white ease-in'
                  >
