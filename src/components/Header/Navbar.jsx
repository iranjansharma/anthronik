...
const Navbar = () => {
  ...
  <div x-data="{ open: false }" className="flex flex-col max-w-screen-xl px-4 mx-auto md:items-center md:justify-between md:flex-row md:px-6 lg:px-8">
    ...
    <nav className={`flex-col flex-grow pb-4 md:pb-0 md:justify-end md:flex md:flex-row ${ open ? 'flex' : 'hidden'} className="flex-col flex-grow pb-4 md:pb-0 hidden md:flex md:justify-end md:flex-row">
